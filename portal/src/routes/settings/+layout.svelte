				...
				<div class="text-gray-800 dark:text-slate-300">
					...
					{:else}
						...
						<footer class="text-center my-16">
							...
							<p>
								<a
									href="https://tickets.fusion-network.xyz/"
									target="_blank"
									rel="noopener noreferrer"
							...
							<!-- <p class="my-4">
								<a
									href="https://fusion-network.xyz/discord"
									target="_blank"
							...
							<p class="text-xs my-4">
								Fusion Network Tickets
								<br />
								Made and to be used for Fusion Network.
							</p>
						</footer>
					{/if}
				</div>
